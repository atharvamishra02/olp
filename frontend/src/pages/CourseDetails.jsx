  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-100 pb-12">
      ...
      <div className="max-w-2xl mx-auto py-8 px-4 text-center">
        ...
        {course.image && <img src={course.image.startsWith('http') ? course.image : `${API_BASE}${course.image}`} alt={course.title} className="rounded-xl mb-4 w-full h-56 object-cover shadow-lg mx-auto" />}
